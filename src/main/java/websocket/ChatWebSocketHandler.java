...
public class ChatWebSocketHandler implements WebSocketHandler {
    ...
    public void handleMessage(WebSocketSession session,
        ...
        ChatMsg msg =
                new Gson().fromJson(webSocketMessage.getPayload().toString(),
                        ChatMsg.class);
        ...
        //发送Socket信息
        sendMsgToUser(msg.getChatUserId(),
                new TextMessage(new GsonBuilder().setDateFormat("yyyy-MM-dd " +
                        "HH:mm:ss").create().toJson(msg)));
    }

    //发送信息的实现
    private void sendMsgToUser(int uid, TextMessage message)
            throws IOException {
    ...
    public void afterConnectionClosed(WebSocketSession webSocketSession,
        ...
        Iterator<Map.Entry<Integer, WebSocketSession>> iterator =
