...
!function (e) {
    ...
    return function i(s, a, l) {
        ...
        8: [function (e, t, n) {
            "use strict";
            var f = e("./utils/url"), r = e("./utils/event"), h = e("json3"),
                d = e("./facade"), o = e("./info-iframe-receiver"),
                p = e("./utils/iframe"), v = e("./location"), m = function () {
                };
        ...
        9: [function (e, t, n) {
            "use strict";
            var r = e("events").EventEmitter, o = e("inherits"), s = e("json3"),
                a = e("./utils/object"), l = function () {
                };
        ...
        11: [function (n, o, e) {
            (function (r) {
                "use strict";
                var i = n("events").EventEmitter, e = n("inherits"),
                    s = n("json3"), a = n("./utils/event"),
                    l = n("./transport/iframe"),
                    c = n("./info-iframe-receiver"), u = function () {
                    };
        ...
        12: [function (e, t, n) {
            ...
            var r = e("events").EventEmitter, o = e("inherits"),
                i = e("./utils/url"), s = e("./transport/sender/xdr"),
                a = e("./transport/sender/xhr-cors"),
                l = e("./transport/sender/xhr-local"),
                c = e("./transport/sender/xhr-fake"), u = e("./info-iframe"),
                f = e("./info-ajax"), h = function () {
                };
        ...
        14: [function (_, E, e) {
            (function (i) {
                "use strict";
                _("./shims");
                var r, l = _("url-parse"), e = _("inherits"), s = _("json3"),
                    c = _("./utils/random"), t = _("./utils/escape"),
                    u = _("./utils/url"), a = _("./utils/event"),
                    n = _("./utils/transport"), o = _("./utils/object"),
                    f = _("./utils/browser"), h = _("./utils/log"),
                    d = _("./event/event"), p = _("./event/eventtarget"),
                    v = _("./location"), m = _("./event/close"),
                    b = _("./event/trans-message"), y = _("./info-receiver"),
                    g = function () {
                    };
        ...
        15: [function (e, t, n) {
            "use strict";
            var o, u = Array.prototype, i = Object.prototype,
                r = Function.prototype, s = String.prototype, a = u.slice,
            ...
            d(u, {
                forEach: function (e) {
                    var t = p(this), n = w && c(this) ? this.split("") : t,
                        r = arguments[1], o = -1, i = n.length >>> 0;
        ...
        17: [function (o, f, e) {
            (function (e) {
                "use strict";
                var i = o("events").EventEmitter, t = o("inherits"),
                    s = o("../../utils/event"), a = o("../../utils/url"),
        ...
        20: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), o = e("./lib/ajax-based"),
                i = e("./receiver/eventsource"), s = e("./sender/xhr-cors"),
                a = e("eventsource");
        ...
        21: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), o = e("./receiver/htmlfile"),
                i = e("./sender/xhr-local"), s = e("./lib/ajax-based");
        ...
        22: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), o = e("json3"), i = e("events").EventEmitter,
                s = e("../version"), a = e("../utils/url"),
                l = e("../utils/iframe"), c = e("../utils/event"),
                u = e("../utils/random"), f = function () {
                };
        ...
        23: [function (s, a, e) {
            (function (e) {
                "use strict";
                var t = s("inherits"), n = s("./lib/sender-receiver"),
                    r = s("./receiver/jsonp"), o = s("./sender/jsonp");
        ...
        24: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), a = e("../../utils/url"),
                o = e("./sender-receiver"), l = function () {
                };
        ...
        28: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), a = e("../../utils/url"),
                l = e("./buffered-sender"), c = e("./polling"),
                u = function () {
                };
        ...
        30: [function (n, u, e) {
            (function (r) {
                "use strict";
                var e = n("inherits"), o = n("../../utils/iframe"),
                    i = n("../../utils/url"), s = n("events").EventEmitter,
        ...
        31: [function (t, n, e) {
            (function (i) {
                "use strict";
                var r = t("../../utils/iframe"), s = t("../../utils/random"),
                    a = t("../../utils/browser"), o = t("../../utils/url"),
                    e = t("inherits"), l = t("events").EventEmitter,
                    c = function () {
                    };
        ...
        33: [function (e, t, n) {
            (function (s) {
                "use strict";
                var a, l, c = e("../../utils/random"), u = e("../../utils/url"),
                    f = function () {
                    };
        ...
        34: [function (r, c, e) {
            (function (i) {
                "use strict";
                var o = r("events").EventEmitter, e = r("inherits"),
                    s = r("../../utils/event"), t = r("../../utils/browser"),
        ...
        38: [function (e, t, n) {
            "use strict";
            var i = e("../utils/event"), s = e("../utils/url"),
                r = e("inherits"), a = e("events").EventEmitter,
        ...
        39: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), o = e("./lib/ajax-based"),
                i = e("./xdr-streaming"), s = e("./receiver/xhr"),
                a = e("./sender/xdr");
        ...
        40: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), o = e("./lib/ajax-based"),
                i = e("./receiver/xhr"), s = e("./sender/xdr");
        ...
        41: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), o = e("./lib/ajax-based"),
                i = e("./receiver/xhr"), s = e("./sender/xhr-cors"),
        ...
        42: [function (l, c, e) {
            (function (e) {
                "use strict";
                var t = l("inherits"), n = l("./lib/ajax-based"),
                    r = l("./receiver/xhr"), o = l("./sender/xhr-cors"),
        ...
        47: [function (t, p, e) {
            (function (f) {
                "use strict";
                var h = t("./event"), n = t("json3"), e = t("./browser"),
                    d = function () {
                    };
                p.exports = {
                    WPrefix: "_jp",
            ...
            (function (s) {
                (function () {
                    ...
                    function W(e, l) {
                        ...
                        var c = e.Number || D.Number, u = e.String || D.String,
                            t = e.Object || D.Object, f = e.Date || D.Date,
                        ...
                        var j, S, T, i = t.prototype, O = i.toString,
                        ...
                        if (!d("json")) {
                            var p = "[object Function]", C = "[object Number]",
                                N = "[object String]", A = "[object Array]",
        ...
        58: [function (e, t, n) {
            (function (i) {
                ...
                function y(e, t, n) {
                    ...
                    var r, o, i, s, a, l, c = v.slice(), u = typeof t, f = this,
                        h = 0;
